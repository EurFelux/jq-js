...
describe('jq official: format', () => {
  ...
  test(`.[] | . as {\$a, b: [\$c, {\$d}]} ?// [\$a, {\$b}, \$e] ?// \$f | [\$a, \$b, \$c, \$d, \$e, \$f] | [{"a":1, "b":[2,{"d":3}]}, [4, {"b":5, "c":6}, 7, 8, 9], "foo"]`, () => {
    ...
    const result = jq(`.[] | . as {\$a, b: [\$c, {\$d}]} ?// [\$a, {\$b}, \$e] ?// \$f | [\$a, \$b, \$c, \$d, \$e, \$f]`, input);
    expect(result).toEqual([JSON.parse(`[1, null, 2, 3, null, null]`), JSON.parse(`[4, 5, null, null, 7, null]`), JSON.parse(`[null, null, null, null, null, "foo"]`)]);
  });
